                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="form-group"><label class="form-label">National Identity Number (NIN)<span
                                ...
                                <div class="input-group"><input class="form-control" type="text"
                                        id="national_identity_number" name="national_identity_number" pattern="^[0-9]+$"
                                        maxlength="11" minlength="11" required="">
                                    <div class="input-group-append"><button class="btn btn-danger"
                                            type="button">Fetch</button></div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group"><label class="form-label" id="first_name" name="first_name">First
                                ...
                                <div><input class="form-control" type="text" required="" pattern="^[a-zA-Z \-]+$"
                                        minlength="2" maxlength="30"></div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group"><label class="form-label">Middle Name</label>
                                <div><input class="form-control" type="text" id="middle_name" name="middle_name"
                                        minlength="2" maxlength="30" pattern="^[a-zA-Z \-]+$"></div>
                            </div>
                        </div>
                        <div class="col-12">
