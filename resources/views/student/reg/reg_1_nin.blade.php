        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-danger" type="button">Fetch</button>
                        </div>
            ...
            <div class="col-12 mb-3">
                <div class="form-group">
                    ...
                    </div><span class="font-size-12">DD-MM-YYYY</span>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="form-group">
                    <label class="form-label" id="first_name" name="first_name">First
