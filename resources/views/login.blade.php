    ...
    <div id="login_wrapper"><a href="/"><img class="img-fluid"
        ...
        <div id="login_form" class="text-start text-dark">
            <div id="form_heading" class="p-3">
                <span class="h4 text-dark fw-bold">Existing User Login</span>
            </div>
            ...
            <form class="mt-4" method="POST" action="/login">
                ...
                <div class="form-group">
                    <label class="form-label fw-bold"><i class="fas fa-envelope me-2"></i>Password:</label>
                ...
                <div class="form-group">
                    <a class="blue-link" href="/forgot_password">Click here to reset password?</a>
                </div>
            </form>
        </div>
    </div>
